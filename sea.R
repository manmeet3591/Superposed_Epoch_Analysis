...
print(enso)
#print(900:1103)
#event.years <- c(1108, 1171, 1230, 1345, 1601, 1641, 1783, 1809, 1815, 1991, 1964, 1884, 1862, 1836, 1832, 1832, 1695, 1595, 1585, 1458, 1453, 1286, 1276, 1258, 1210, 1191, 1182, 1127, 1028, 1003, 976, 939, 916)
...
#par(new=TRUE)
#abline(h=enso.sea$ci.99.upper, lwd=1)
#par(new=TRUE)
